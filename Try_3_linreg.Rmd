...
CV <- data.frame(tr[CV_subset, ], tr[CV_subset,] ^ 2, tr[CV_subset,] ^ 3)
CV_y <- tr_y[CV_subset, ]

tr <- data.frame(tr[-CV_subset, ], tr[-CV_subset,] ^ 2, tr[-CV_subset,] ^ 3)
tr_y <- tr_y[-CV_subset, ]

CV_pr <- data.frame(tr_pr[CV_subset, ], tr_pr[CV_subset,] ^ 2, tr_pr[CV_subset,] ^ 3)
tr_pr <- data.frame(tr_pr[-CV_subset, ], tr_pr[-CV_subset,] ^ 2, tr_pr[-CV_subset,] ^ 3)
```
